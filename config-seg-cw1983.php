...
if($maintenance){die($mtitle);die;exit;}
...
$boardurl="http://casitaweb.net";
$no_avatar='http://casitaweb.net/avatar.gif';
$boarddir='/mounted-storage/home1/sub008/sc69085-DUJX/casitaweb.net/';
$themedir='/mounted-storage/home1/sub008/sc69085-DUJX/casitaweb.net/web/archivos/base';
$sourcedir='/mounted-storage/home1/sub008/sc69085-DUJX/casitaweb.net/web/archivos/raizSeG414';
$tranfer1='/images';
...
global $mnc; $mnc=isset($mnc) ? $mnc : '0';
if($mnc){die();exit();}
else{
$db_server='mysql1081.servage.net';
$db_name='Lgzijda7';
$db_user='Lgzijda7';
$db_passwd="ruaQEfAWphovx1ZZY";
$db_prefix="cw_";
$db_last_error=base64_decode("MA==");
$db_character_set=base64_decode("dXRmOA==");
$db_connection=@mysql_connect($db_server, $db_user, $db_passwd);
if(!$db_connection || !@mysql_select_db($db_name, $db_connection)){die($errordb);die();} }
$navegador=getenv("HTTP_USER_AGENT");
if(preg_match("/MSIE/i", "$navegador")){$ie = true;}else{$ie = false;} ?>