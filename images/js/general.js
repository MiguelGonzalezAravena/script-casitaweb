eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('4 2=d.o.p();4 q=r(d.s);4 t=((2.3("u")!=-1)&&(2.3("f")==-1));4 v=((2.3(\'g\')!=-1)&&(2.3(\'w\')==-1)&&(2.3(\'x\')==-1)&&(2.3(\'f\')==-1)&&(2.3(\'y\')==-1)&&(2.3(\'z\')==-1));4 A=((2.3("B")!=-1)||(2.3("C")!=-1));4 D=(2.3("E")!=-1);4 F=0;6 G(a){7(h.i)5 h.i(a);H 7(8[a])5 8[a];5 9}6 I(a){a.J();a.K()}6 j(){4 a=9;L{a=8.k?l k():l M("N.O")}P(e){Q("R S T U V W, X Y Z 10 11 12 (13://14.g-15.16/17/18/)")}5 a}4 19=j();6 1a(a){4 b;7(a===""||a===0||a==="0"||a===9||a===c||m a==="1b")5 n;7(m a=="1c"){1d(b 1e a)5 c;5 n}5 c};',62,77,'||clientPC|indexOf|var|return|function|if|window|null|||false|navigator||opera|mozilla|document|getElementById|createXMLHttpRequest|XMLHttpRequest|new|typeof|true|userAgent|toLowerCase|clientVer|parseInt|appVersion|is_ie|msie|is_nav|spoofer|compatible|webtv|hotjava|is_win|win|16bit|is_mac|mac|is_moz|el|else|selectycopy|focus|select|try|ActiveXObject|Microsoft|XMLHTTP|catch|alert|Tu|explorador|no|soporta|este|sitema|CasitaWeb|te|recomienda|que|uses|Firefox|http|www|europe|org|es|firefox|xhr|empty|undefined|object|for|in'.split('|'),0,{}))

eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('0 6(2){3(2==1){$(\'#4\').7(\'8\')}5{$(\'#4\').9()}}0 a(){$(\'.b-c\').d();e}0 f(){3($(".g").h("i")){}5{j()}$(\'#k\').l();m()}',23,23,'function||s|if|cargando_boxy|else|loadcargando|fadeIn|fast|hide|cerrarBox|boxy|wrapper|remove|return|irAconectarse|hdLoglink|hasClass|opened|servicenavlogin|nickname|focus|ira_CasitaWebNET'.split('|'),0,{}))

/* POP UP EMOTICONES*/
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('0 1(){2 a=3.4("/5/6-7.8","","9=b,c=d,e")}',15,15,'function|moticonup|var|window|open|web|cw|emoticones|php|width||225px|height|500px|scrollbars'.split('|'),0,{}))

/* IR A*/
eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}(';(4(d){7 k=d.y=4(a,i,e){d(C).y(a,i,e)};k.N={D:\'14\',O:P(d.E.15)>=1.3?0:1};k.C=4(a){6 d(C).F()};d.E.F=4(){6 8.16(4(){7 a=8,i=!a.Q||d.17(a.Q.G(),[\'18\',\'#R\',\'H\',\'9\'])!=-1;5(!i)6 a;7 e=(a.19||a).R||a.I||a;6 d.1a.1b||e.1c==\'1d\'?e.9:e.S})};d.E.y=4(n,j,b){5(z j==\'J\'){b=j;j=0}5(z b==\'4\')b={T:b};5(n==\'A\')n=1e;b=d.1f({},k.N,b);j=j||b.1g||b.O;b.v=b.v&&b.D.1h>1;5(b.v)j/=2;b.w=p(b.w);b.B=p(b.B);6 8.F().U(4(){7 q=8,r=d(q),f=n,s,g={},u=r.K(\'H,9\');1i(z f){L\'1j\':L\'1k\':5(/^([+-]=)?\\d+(\\.\\d+)?(1l|%)?$/.V(f)){f=p(f);1m}f=d(f,8);L\'J\':5(f.K||f.1n)s=(f=d(f)).w()}d.U(b.D.1o(\'\'),4(a,i){7 e=i==\'x\'?\'1p\':\'1q\',h=e.G(),c=\'W\'+e,l=q[c],m=k.A(q,i);5(s){g[c]=s[h]+(u?0:l-r.w()[h]);5(b.X){g[c]-=Y(f.Z(\'X\'+e))||0;g[c]-=Y(f.Z(\'1r\'+e+\'10\'))||0}g[c]+=b.w[h]||0;5(b.B[h])g[c]+=f[i==\'x\'?\'1s\':\'1t\']()*b.B[h]}1u{7 o=f[h];g[c]=o.11&&o.11(-1)==\'%\'?P(o)/1v*m:o}5(/^\\d+$/.V(g[c]))g[c]=g[c]<=0?0:M.12(g[c],m);5(!a&&b.v){5(l!=g[c])t(b.1w);1x g[c]}});t(b.T);4 t(a){r.1y(g,j,b.1z,a&&4(){a.1A(8,n,b)})}}).1B()};k.A=4(a,i){7 e=i==\'x\'?\'10\':\'1C\',h=\'W\'+e;5(!d(a).K(\'H,9\'))6 a[h]-d(a)[e.G()]();7 c=\'1D\'+e,l=a.I.S,m=a.I.9;6 M.A(l[h],m[h])-M.12(l[c],m[c])};4 p(a){6 z a==\'J\'?a:{13:a,1E:a}}})(1F);4 1G(){$("#13").y(0,1H,{v:1I});6 1J}',62,108,'||||function|if|return|var|this|body||||||||||||||||||||||queue|offset||scrollTo|typeof|max|over|window|axis|fn|_scrollable|toLowerCase|html|ownerDocument|object|is|case|Math|defaults|duration|parseFloat|nodeName|document|documentElement|onAfter|each|test|scroll|margin|parseInt|css|Width|slice|min|top|xy|jquery|map|inArray|iframe|contentWindow|browser|safari|compatMode|BackCompat|9e9|extend|speed|length|switch|number|string|px|break|style|split|Left|Top|border|width|height|else|100|onAfterFirst|delete|animate|easing|call|end|Height|client|left|jQuery|ira_CasitaWebNET|800|true|false'.split('|'),0,{}))
...
function actualizar_comentarios() {
  ...
  $.ajax({
    type: 'POST',
    url: urlWEb + '/web/cw-ActComentarios.php',
    success: function(h){
      $('#ult_comm').html(h);
...
function foco(elemento){elemento.style.border="1px solid #878787";elemento.style.color="#333333";}
function no_foco(elemento){elemento.style.border="1px solid #CCCCCC";elemento.style.color="#6B6B6B";}
...
$.ajax({
		...
		data: 'id=' + id ,
		success: function(h){
				if(h.charAt(0)==0) Boxy.alert(h.substring(3), null, {title: 'Alerta'});
...
function votar_img(id, puntos){
	...
	$.ajax({
		...
		error: function(){Boxy.alert("Error, volver a intentar...", null, {title: 'Alerta'});}
	});
}
	...
	$.ajax({
		...
		success: function(h){
			...
			$("#span_opciones2").fadeOut("slow", function(){
				if(h.charAt(0)==0){	$('#span_opciones2').addClass('status_error');}
				else if(h.charAt(0)==1){$('#cant_favs_post').html(parseInt($('#cant_favs_post').html()) + 1);
					$('#span_opciones2').addClass('status_ok');}
				$('#span_opciones2').html(h.substring(3));
				$("#span_opciones2").slideDown("slow", function(){
				if(h.charAt(0)==1) sleep(1000);	else sleep(2500);
				$("#span_opciones2").fadeOut("slow", function(){
...
//Enviar Denuncia
function enviarDen(tipo,id){if($('#cDen').val() == ''){$('#cDen').focus(); return false;}
...
/* MIEMBROS COMUNIDADESPAGINADESAPROBADOS */
...
if($('#titulo').val() == ''){$('#titulo').focus(); return false;}
if($('#comment').val() == ''){$('#comment').focus(); return false;}
if($('.r_email').val() == ''){$('.r_email').focus(); return false;}
$('#cargandoBoxyc').css('display','none');
$('#cargandoBoxy').css('display','block');
...
if($('#url').val() == ''){$('#url').focus(); return false;}
$('#cargandoBoxyc').css('display','none');
$('#cargandoBoxy').css('display','block');
$.ajax({
		type: 'POST',
		url: '/web/cw-imgAgregar.php',
		cache: false,
...
function add_comment(id, nro){
	if($('#editorCW').val() == ''){$('#editorCW').focus();return;}
	$('.msg_add_comment').hide();
	$('#gif_cargando_add_comment').css('display', 'block');
	$.ajax({
		type: 'POST',
		url: '/web/cw-comentarPost.php',
...
$.ajax({
		...
		success: function(h){$('#amistadesACT').html(h.substring(3));},
        error: function(){Boxy.alert("Error, volver a intentar...", null, {title: 'Alerta'});}});
        }
  
 function elegir(tipo){  if(this.tipo==tipo)	return; if(tipo=='google'){ $('input[name="buscador_tipo"]').val('g'); $('#gb').addClass('activo');$('#cwb').removeClass('activo');}else if(tipo=='casitaweb'){$('#cwb').addClass('activo');$('#gb').removeClass('activo');$('input[name="buscador_tipo"]').val('c');} }
 
function errorrojos(q){if(q==''){$('input[name="q"]').focus(); return false;}}
 
/*SLEEP*/
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('6 7(a){2 b=3 4().5();8(2 1=0;1<9;1++){c((3 4().5()-b)>a){d}}}',14,14,'|i|var|new|Date|getTime|function|sleep|for|1e7|||if|break'.split('|'),0,{}))
...
$(document).ready(function(){ $('#editorCW').editorCW(bbcode);$('.boxy').boxy(); drawSocialLinks($('#social'));
$('#salir_cw').click(function() {
    Boxy.confirm("&iquest;Estas seguro que desea salir de su cuenta?", function() { salir(); }, {title: 'Salir'}); 
    return false;
  });
});