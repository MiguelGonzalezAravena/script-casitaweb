...
var SAT_VAL_SQUARE_LOCATION = boardUrl + '/images/sv.png';
var BUTON_CLOSE_LOCATION = boardUrl + '/images/eliminar.gif';
var HEIGHT_OF_OBJ = 0;
var WIDTH_OF_OBJ = 0;
...
buttonCloseImg.width = 10;
buttonCloseImg.height = 10;
...
function makeColorSelector(inputBox) {
  ...
  butonclose.style.width = '10px';
  butonclose.style.padding = '2px';
  butonclose.style.left = "227px";
...
function startColorPicker(inputObj) {
  ...
  color_picker_div.style.padding = '0px';
  color_picker_div.style.margin = '0px';
  color_picker_div.id = 'The_colorPicker';
  color_picker_div.style.position = 'relative';
  color_picker_div.appendChild(makeColorSelector(inputObj));
  document.getElementById('coloraca').style.display = "block";
  document.getElementById('coloraca').appendChild(color_picker_div);
  is_div_init = true;
}
...
function hideColorPicker() {
  ...
  if (is_div_init) {
    is_div_init = false;
    document.getElementById('coloraca').removeChild(document.getElementById('The_colorPicker'));
    document.getElementById('coloraca').style.display = "none";
  }
}
