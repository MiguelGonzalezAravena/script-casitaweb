...
jQuery(this).click(function(){
    ...
    jQuery(this).bind('submit.boxy', function() {
        Boxy.confirm(options.message || 'Confirmar:', function() {jQuery(self).unbind('submit.boxy').submit();}); return false; });
...
jQuery.extend(Boxy, {
    ...
    load: function(url, options) {
        ...
        options = options || {};
        var ajax = {
            url: url, type: 'GET', dataType: 'html', data: 'ajaxboxy=si', cache: false, success: function(html) {
                html = jQuery(html);
    ...
    confirm: function(message, after, options) {
        return Boxy.ask(message, ['Aceptar', 'Cancelar'], function(response) {
            if (response == 'Aceptar') after();
        }, options);
    },
    ...
    ask: function(question, answers, callback, options) {
        ...
        buttons.html(jQuery.map(answerStrings, function(v) {
            return "<input style='cursor:pointer;' type='button' value='" + v + "' />";
        }).join(' '));
