<?php require("cw-conexion-seg-0011.php"); 
    ...
    if(!$user_info['is_guest']){die('0: <div class="noesta">Ya iniciastes sesi&oacute;n.</div>');}
	...
	{die('0: <div class="noesta-am">Aceptacion: <a href="/conectar/acepta-'.$user_settings['ID_MEMBER'] . '">A</a>.</div>');}
	elseif ($activation_status == 3)
	die('0: <div class="noesta-am">Esperando activaci&oacute;.</div>');
	elseif ($activation_status != 1)
	{
	die('0: <div class="noesta-am">Tu cuenta esta desactivada porque se le cambio el e-mail.
 <br />Si no te llego el e-mail de confirmaci&oacute;n puedes renviarlo entrando <a href="/reactivar-' . $user_settings['ID_MEMBER'] . '">ACA</a>.</div>');}
...
require($sourcedir.'/Subs-Compat.php');
$other_passwords[]=sha1_casitaweb(strtolower($user_settings['memberName']).un_htmlspecialchars(stripslashes($_REQUEST['passwrd'])));
        ...
        echo'2: <div class="noesta">Intentastes demasiadas veces.<br /> Si te olvidastes de tu contrase&ntilde;a puedes recuperarla con esta funci&oacute;n <a href="/recuperar-pass/">ACA</a></div>';
			exit();die();}
		else
		{die('0: <div class="noesta">Cuenta incorrecta.</div>');}
		}
	...
	elseif (empty($user_settings['passwordSalt']))
	{
		$user_settings['passwordSalt'] = substr(md5(rand()), 0, 4);
