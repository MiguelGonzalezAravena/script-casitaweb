...
<div style="width: 400px;">
  <img id="cargandoAD" alt="" src="<?php echo $tranfer1; ?>/icons/cargando.gif" style="width: 16px; height: 16px; display: none;" border="0" />
  ...
  <div id="contenidoAD" align="center">
    <form method="POST" action="javascript:addIMG();">
      ...
      <input type="submit" class="login" style="font-size: 15px;" tabindex="3" value="Agregar imagen" />
    </form>
  </div>
</div>