...
if ($context['permisoCom'] == '1' || $context['permisoCom'] == '3') {
  ...
  if ($context['permisoCom'] == 3 && $crngo == 1) {
    ...
    echo '
      <form style="margin: 0px; padding: 0px;" action="/web/cw-comunidadesAdmMem.php" method="POST" accept-charset="' . $context['character_set'] . '">
        <table>
          <tr>
    ...
    if (!$banccc) {
      echo '
      <table><tr><td style="width:100px;"><b>Banear:</b></td> <td><input name="banear" type="checkbox" /><br /></td></tr>
      ...
      echo '
        <div class="noesta">Usuario baneado<br />
        Por: '.$ban_por.'<br />
    ...
    echo '
      <div class="hrs"></div><p style="margin:0px;margin:0px;" align="right"><input alt="" class="login" title="Aceptar" value="Aceptar" type="submit" /></p>
