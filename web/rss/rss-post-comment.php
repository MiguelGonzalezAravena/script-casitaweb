...
global $tranfer1,$db_prefix,$user_info,$context;
$contador=mysql_num_rows(db_query("SELECT id_post FROM {$db_prefix}comentarios WHERE id_post='$id'",__FILE__, __LINE__));
...
if($rssuser['postprivado']=='1'){echo'<center><i>Este es un post privado, para verlo debes autentificarte. - casitaweb.net</i></center><br />';}else{
echo achicar400($rssuser['body']);}}else{echo achicar400($rssuser['body']);}
echo']]></description>
