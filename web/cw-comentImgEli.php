...
$existe=mysql_num_rows(db_query("SELECT c.ID_COMMENT
...
$ccc=mysql_num_rows(db_query("SELECT c.ID_COMMENT FROM ({$db_prefix}gallery_comment AS c) WHERE c.ID_PICTURE='$topic' LIMIT 1", __FILE__, __LINE__));
