...
function acciones() {
  global $db_prefix, $context, $user_settings, $user_info, $txt, $boardurl, $mbname;

  $palabra = isset($_GET['palabra']) ? seguridad($_GET['palabra']) : '';
  ...
  } else if ($_GET['m'] == 'tyc14') {
    // Nube Tags
    $context['page_title'] = 'Nube de Tags';
  } else if ($_GET['m'] == 'tyc13' && $palabra) {
    // Tags
    if ($palabra) {
      $context['page_title'] = $palabra;
    } else {
  ...
  if (seguridad($_GET['m']) == 'vr2965') {
    if (($user_info['is_admin'] || $user_info['is_mods'])) {
      ...
      $context['admin_tabs'] = array(
        'title' => 'BatiCueva',
        'help' => 'comunicacion',
        'description' => 'Esto es una seccion donde los moderadores del sitio van a poder comunicarse entre ellos, a trav&eacute;s de posts y comentarios que son ocultos para todo p&uacute;blico.',
        'tabs' => array(),
      );
      ...
      $context['admin_tabs']['tabs'][] = array(
        'title' => 'Agregar post',
        'description' => 'Esto es una secci&oacute;n donde los moderadores del sitio ' . $mbname . ' van a poder comunicarse entre ellos, a trav&eacute;s de posts y comentarios que son ocultos para todo p&uacute;blico.',
      ...
      if ($_GET['id'])
        $context['admin_tabs']['tabs'][] = array(
          ...
          'description' => 'Esto es una seccion donde los moderadores del sitio ' . $mbname . ' van a poder comunicarse entre ellos, a trav&eacute;s de posts y comentarios que son ocultos para todo p&uacute;blico.',
