...
function Login(){global $txt, $context;
if (WIRELESS)$context['sub_template'] = WIRELESS_PROTOCOL . '_login';else{
loadLanguage('Login');
loadTemplate('Login');
$context['sub_template'] = 'login';}
	...
	$_SESSION['login_url'] = $_SESSION['old_url'];	else	unset($_SESSION['login_url']);}
