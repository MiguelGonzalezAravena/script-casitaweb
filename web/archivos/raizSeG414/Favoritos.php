...
function Favoritos(){global $txt, $context, $scripturl, $db_prefix, $user_info, $ID_MEMBER, $return;
$_GET['m']=str_replace("/","",$_GET['m']);
loadTemplate('Favoritos');
if(!$context['user']['is_logged']){fatal_error($txt['bookmark_not_for_guests'], false);}
$context['all_pages'] = array(
		'post' => 'intro',
		'imagen' => 'imagen',
);
if (!isset($_GET['m']) || !isset($context['all_pages'][$_GET['m']]))$_GET['m'] = 'post';
