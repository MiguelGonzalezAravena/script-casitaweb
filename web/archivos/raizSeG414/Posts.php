...
function Posts() {
  ...
  if ($context['user']['is_guest'] && $context['oculto']) {
...
function post_error($titulo = '') {
  global $tranfer1, $context, $settings, $options, $txt, $db_prefix, $boardurl, $mbname;
  ...
  echo '
    <div class="noesta" style="margin-bottom: 8px; width: 922px">
      <div class="post-deleted">
        <h3>Este post no existe o fue eliminado!</h3>
        Pero OJO, no es el &uacute;nico post en ' . $mbname . '.
      </div>
    </div>
