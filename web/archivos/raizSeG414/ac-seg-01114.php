...
function acseg() {
  ...
  } else if ($context['current_page'] == 'tyc17') {
    $context['page_title'] = 'Mis notas';
  } else {
    $context['page_title'] = $txt[18];
  }

  if ($context['current_page'] == 'tyc17' && $context['user']['is_guest']) {
    is_not_guest();
  }

  if ($context['current_page'] == 'tyc23' && $context['user']['is_guest']) {
    is_not_guest();
  }

  if ($context['current_page'] == 'tyc12') {
