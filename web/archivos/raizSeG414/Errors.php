...
function db_error($db_string, $file, $line) {
  ...
  if (allowedTo('admin_forum'))
    ...
    $context['error_message'] = 'Hubo un error, Intentar nuevamente.<br /><br />' . $query_error;
...
function fatal_error($error, $log = false, $title = null, $botn = null) {
  ...
  if (empty($botn) || $botn == '1') {
    ...
    if ($botn == '901') {
      $context['boton'] = '<input class="login" style="font-size: 11px;" type="submit" title="Ir a la P&aacute;gina principal" value="Ir a la P&aacute;gina principal" onclick="location.href=\'' . $boardurl . '\'" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a centro de bans" value="Ir a centro de bans" onclick="location.href=\'' . $boardurl . '/moderacion/edit-user/ban/lista/\'" />';
    }
    ...
    if ($botn == '3') {
      $context['boton'] = '<input class="login" style="font-size: 11px;" type="submit" title="Ir al post" value="Ir al post" onclick="location.href=\'' . $boardurl . '/post/' . $_REQUEST['id_top'] . '/' . urls(censorText($_REQUEST['description'])) . '/' . urls(censorText($_REQUEST['subject'])) . '.html\'" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a la P&aacute;gina principal" value="Ir a la P&aacute;gina principal" onclick="location.href=\'' . $boardurl . '/\'" />';
    }

    if ($botn == '4') {
      $context['boton'] = '<input class="login" style="font-size: 11px;" type="button" title="Volver atr&aacute;s" value="Volver atr&aacute;s" onclick="history.back()" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a la P&aacute;gina principal" value="Ir a la P&aacute;gina principal" onclick="location.href=\'' . $boardurl . '/\'" />';
    }

    if ($botn == '5') {
      $idpost = isset($_GET['topic']) ? (int) $_GET['topic'] : 0;
      $request = db_query("
        SELECT p.subject, p.ID_TOPIC, c.description
        FROM {$db_prefix}messages as p, {$db_prefix}boards as c
        WHERE p.ID_TOPIC = $idpost
        AND p.ID_BOARD = c.ID_BOARD", __FILE__, __LINE__);
      ...
      $context['boton'] = '<input class="login" style="font-size: 11px;" type="submit" title="Volver al post" value="Volver al post" onclick="location.href=\'' . $boardurl . '/post/' . $ID_TOPIC . '/' . urls(censorText($description)) . '/' . urls(censorText($titulo)) . '.html\'" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a favoritos" value="Ir a favoritos" onclick="location.href=\'' . $boardurl . '/favoritos/post/\'" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a la P&aacute;gina principal" value="Ir a la P&aacute;gina principal" onclick="location.href=\'' . $boardurl . '/\'" />';
    }

    if ($botn == '6') {
      $idpost = isset($_GET['kjas']) ? (int) $_GET['kjas'] : 0;
      $context['boton'] = '<input class="login" style="font-size: 11px;" type="submit" title="Volver a la imagen" value="Volver a la imagen" onclick="location.href=\'' . $boardurl . '/imagenes/ver/'.$idpost.'\'" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a favoritos" value="Ir a favoritos" onclick="location.href=\'' . $boardurl . '/favoritos/imagen/\'" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a la P&aacute;gina principal" value="Ir a la P&aacute;gina principal" onclick="location.href=\'' . $boardurl . '/\'" />';
    }

    if ($botn == '7') {
      $id = isset($_GET['id']) ? (int) $_GET['id'] : 0;
      $context['boton'] = '<input class="login" style="font-size: 11px;" type="submit" title="Volver a la imagen" value="Volver a la imagen" onclick="location.href=\'' . $boardurl . '/imagenes/ver/'.$id.'/\'" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a la P&aacute;gina principal" value="Ir a la P&aacute;gina principal" onclick="location.href=\'' . $boardurl . '/\'" />';
    }

    if ($botn == '9') {
      $context['boton'] = '<input class="login" style="font-size: 11px;" type="submit" title="Volver atr&aacute;s" value="Volver atr&aacute;s" onclick="location.href=\'' . $boardurl . '/ingresar/\'" /> <input class="login" style="font-size: 11px;" type="submit" title="Ir a la P&aacute;gina principal" value="Ir a la P&aacute;gina principal" onclick="location.href=\'' . $boardurl . '/\'" />';
    }
  }
  ...
  if ($context['boton']) {
    ...
    echo '<div align="center" class="noesta" style="width: 922px;">' . $error . '</div>';
  }
