...
captcha(2);
    ...
    require_once($sourcedir . '/Subs-Post.php');
       sendmail($row['emailAddress'], 'Recuperar mi Password',
		sprintf("Se ha enviado este mensaje porque se ha aplicado la funci�n \"Recuperar mi Password\" en tu cuenta. Para establecer un nuevo Password haz clic en el siguiente enlace:\n") .
