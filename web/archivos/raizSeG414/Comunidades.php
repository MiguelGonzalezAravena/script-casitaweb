...
function Comunidades(){global $context, $user_settings, $sourcedir, $txt,$db_prefix,$urlSep;
...
elseif($context['current_page']== 'articulo'){
...
elseif($context['current_page']== 'index'){
include($sourcedir.'/FuncionesCom.php');
if($context['comuid']){
$rs=db_query("
...
if(empty($context['ddddsaaat'])){fatal_error('Esta comunidad no existe.');}
