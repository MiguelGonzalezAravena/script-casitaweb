...
function resetPassword($memID, $username = null) {
  global $db_prefix, $scripturl, $context, $txt, $sourcedir, $modSettings, $mbname, $boardurl;
  ...
  if ($username !== null) {
    ...
    sendmail(
      $email,
      'Cambio de nick',
      'Te comentamos que se ha cambiado tu nick en ' . $mbname . '<br />' .
      'Por cuestiones de seguridad tambi&eacute;n se ha cambiado la contrase&ntilde;a.' .
      "\n\n" .
      'Nick: ' . $user . ', Contrase&ntilde;a: ' . $newPassword .
      "\n\n".
      $txt[701] . '<br />' .
      '<a href="' . $boardurl . '/perfil/' . $user . '">' . $boardurl . '/perfil/' . $user . '</a>'
    );
  }
