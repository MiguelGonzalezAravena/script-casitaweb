...
function KickGuest(){echo is_not_guest();}
...
function resetPassword($memID, $username = null){global $db_prefix, $scripturl, $context, $txt, $sourcedir, $modSettings;
	...
	if ($username !== null)
	{if(empty($user))fatal_lang_error(37, false);
...
function validatePassword($password, $username, $restrict_in = array()){global $modSettings, $func;
