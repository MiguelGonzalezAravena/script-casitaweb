...
function is_not_guest($q = '',$h = ''){global $user_info, $txt, $context,$tranfer1;
...
if(empty($h)){echo template_main_above();}
...
if(!empty($q)){echo'<div class="noesta">'.$q.'</div>';}
echo'<div style="width:600px;float:left;">
<span style="font-size:40px;color:#606060;">Registrate</span>
<div style="padding-top:25px;padding-left:25px;color:#A5A5A5;height:135px;"><b>
    <div style="margin-bottom:3px;">*  Comparta sus Posts</div>
    <div style="margin-bottom:3px;">*  Ver perfiles y a&ntilde;adir nuevos amigos</div>
    <div style="margin-bottom:3px;">*  Comente cualquier tipo de posts</div>
    <div style="margin-bottom:3px;">*  Cree su propia comunidad</div>
    <div style="margin-bottom:3px;">*  Unase a todas las comunidades</div>
    <div style="margin-bottom:3px;">*  Comparta sus fotos</div>
    <div style="margin-bottom:3px;">*  Califique posts e imagenes</div>
    <div style="margin-bottom:3px;">*  Tenga organizado sus posts e imagenes favoritas</div>
</b><div style="clear:both"></div> </div>
<div style="padding-top:20px;text-align:right;width:400px;"><input class="login" style="font-size:19px;" type="submit" onclick="location.href=\'http://casitaweb.net/registrarse/\'" value="Registrarse!!!" /></div>
</div>
...
<div id="hd_loginbox2">
<div style="display: none;" id="login_cargando2"><img alt="" src="'.$tranfer1.'/icons/cargando.gif" width="16px" height="16px" /></div><div style="display: none;" id="login_error2"></div><div class="login_cuerpo2"><div><label>Nick: </label><br /><input style="width:200px;" maxlength="64" name="nick" id="nickname" onfocus="foco(this);" onblur="no_foco(this);" class="loginuserid" type="text" /><br/><label>Contrase&ntilde;a: </label><br /><input style="width:200px;" maxlength="64" name="pass" id="password" onfocus="foco(this);" onblur="no_foco(this);" class="loginpasswd" type="password" /><div style="clear:both"></div> </div><div style="clear:both"></div> </div><div style="clear:both"></div> </div>
<div style="clear:both"></div> 
<div style="padding-top:20px;text-align:right;"><p><input style="font-size:19px;" class="login" type="submit" value="Conectarse" /></p></form><a href="/recuperar-pass/" class="loginforgotpass">&#191;Ha olvidado su password?</a></div>
</div>
</b>
</form>
...
function checkSession($type = 'post', $from_action = '', $is_fatal = true){global $sc, $modSettings, $boardurl;
	...
	if (strtolower($_SERVER['HTTP_USER_AGENT']) == 'hacker')fatal_error('No podes estar aca.', false);
	if (!isset($error))return '';elseif ($is_fatal)
		fatal_lang_error($error, isset($log_error));else return $error;
	trigger_error(base64_decode("d3d3LmNhc2l0YXdlYi5uZXQgLSByaWdv"), E_USER_ERROR);
}
function checkSubmitOnce($action, $is_fatal = true){global $context;
