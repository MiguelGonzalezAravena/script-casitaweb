  ...
  if (!$context['comuid']) {
    ...
    if ($entrar) {
      ...
      <tr><td style="width:100px;"><b>Comunidad:</b></td> <td>' . $context['nombrecat'] . '</td></tr></table><div class="hrs"></div>';
          ...
          if (!$context['ivvvaar']) {
            echo '<table><tr><td style="width:100px;"><b>Eliminar:</b></td> <td><input name="eliminar" type="checkbox" /><br /></td></tr><tr><td style="width:100px;"><b>Raz&oacute;n:</b></td> <td><input onfocus="foco(this);" onblur="no_foco(this);" title="Raz&oacute;n" value="" type="text" name="razon" /></td></tr></table>';
          } else {
...
<div style="float:left;">';
    if ($context['coMnocoment']) {
      echo '<img src="' . $tranfer1 . '/comunidades/cerrado.png" alt="" title="Tema cerrado" /> ';
    }
    if ($context['coMstiky']) {
      echo '<img src="' . $tranfer1 . '/comunidades/fijado.png" alt="" title="Tema fijado" /> ';
    }
    echo '</div>
<div style="float:right;">';
    if ($context['permisoCom'] == '1' || $context['permisoCom'] == '3' || $context['permisoCom'] == '2' || $context['coMvbvbvki'] == $ID_MEMBER) {
      echo '<p align="right" style="margin:0px;padding:0px;">' . $context['botonesCom'] . '</p>';
    }
...
<div class="post-comentCont">' . $comene . '<div class="clearBoth"></div></div>';
    ...
    echo '<div class="coment-user"';
    if (!empty($dasd)) {
      echo ' style="display:none;" ';
    }
    echo '><div class="noesta">Este tema no tiene comentarios.</div></div>';
    echo '</div>';
...
function template_crearcomunidad()
{
  ...
  if (!$user_settings['ID_GROUP']) {
    if ($user_settings['ID_POST_GROUP'] == '4') {
      $cantidadcom = '1';
    } elseif ($user_settings['ID_POST_GROUP'] == '5') {
      $cantidadcom = '2';
    } elseif ($user_settings['ID_POST_GROUP'] == '9') {
      $cantidadcom = '4';
    } elseif ($user_settings['ID_POST_GROUP'] == '10') {
      $cantidadcom = '6';
    } elseif ($user_settings['ID_POST_GROUP'] == '6') {
      $cantidadcom = '8';
    } elseif ($user_settings['ID_POST_GROUP'] == '8') {
      $cantidadcom = '10';
    }
  } elseif ($user_settings['ID_GROUP']) {
    $cantidadcom = '15';
  }
...
<div class="box_title" style="width:352px;"><div class="box_txt box_354-34">Importante</div><div class="box_rss"><div class="icon_img"><img src="' . $tranfer1 . '/blank.gif" style="width:16px;height:16px;" border="0" alt="" /></div></div></div><div style="width:344px;padding:4px;" class="windowbg">';
  reglas_com('crearc');
  echo '</div></div>

<div class="noesta-am" style="margin-bottom:8px;">Tienes ' . ($cantidadcom - $cuantascom) . ' comunidades disponibles para crear</div>

<div class="box_354"><div class="box_title" style="width:352px;"><div class="box_txt box_354-34">Destacados</div><div class="box_rss"><div class="icon_img"><img src="' . $tranfer1 . '/blank.gif" style="width:16px;height:16px;" border="0" alt="" /></div></div></div><div style="width:344px;padding:4px;" class="windowbg">';
  anuncio_300x250();
  echo '</div></div></div><div style="width:560px;float:left;"><div class="box_560"><div class="box_title" style="width: 558px;"><div class="box_txt box_560-34">Crear nueva comunidad</div><div class="box_rss"><div class="icon_img"><img src="' . $tranfer1 . '/blank.gif" style="width:16px;height:16px;" border="0" alt="" /></div></div></div>
...
<div class="form-container"><label for="uname">Titulo:</label><input style="width:540px;" onfocus="foco(this);" onblur="no_foco(this);" class="c_input" value="' . $titulo . '" name="titulo" tabindex="1" datatype="text" dataname="Titulo" type="text"><div class="clearBoth"></div>';
      ...
      if ($context['permisoCom'] == '1' || $context['permisoCom'] == '3') {
        ...
        echo ' id="sticky" value="1" type="checkbox" /> Fijar</label>';
      }
      echo '<label for="nocoment"><input name="nocoment"';
      if ($nocoment) {
        echo ' checked="checked"';
      }
      echo '  id="nocoment" value="1" type="checkbox" /> No permitir comentarios</label></fieldset> 
...
<option value="-1">Elegir una categor&iacute;a</option>';
  while ($row = mysqli_fetch_assoc($request)) {
    echo '<option';
    if ($context['COMediTcategoria'] == $row['url']) {
      echo ' selected="true"';
    }
    echo ' value="' . $row['url'] . '" >' . $row['nombre'] . '</option>';
  }
...
<div class="postLabel" style="display:none;" id="div_acceso">
<fieldset><legend><label for="privada_1" class="tit_lab">Todos</label></legend>
<table><tr><td style="width:18px;padding:0px;margin:0px;"><input name="privada" id="privada_1" value="1"';
  if ($context['COMediTacceso'] == 1) {
    echo ' checked="checked"';
  }
  echo ' tabindex="9" type="radio" /></td><td><p class="descRadio">Toda persona que entra a CasitaWeb! tiene la posibilidad de entrar y ver el contenido de tu comunidad.</p></td></tr></table></fieldset>
<fieldset><legend><label for="privada_2" class="tit_lab">S&oacute;lo usuarios registrados</label></legend><table><tr><td style="width:18px;padding:0px;margin:0px;"><input name="privada" id="privada_2" value="2"';
  if ($context['COMediTacceso'] == 2) {
    echo ' checked="checked"';
  }
  echo ' type="radio" /></td><td><p class="descRadio">Todo aquel que no este registrado en CasitaWeb! no podr&aacute; ver el contenido de tu comunidad.</p></td></tr></table></fieldset>

<fieldset><legend><label for="privada_3" class="tit_lab">S&oacute;lo Miembros</label></legend><table><tr><td style="width:18px;padding:0px;margin:0px;"><input name="privada" id="privada_3" value="3"';
  if ($context['COMediTacceso'] == 3) {
    echo ' checked="checked"';
  }
  echo ' type="radio" /></td><td><p class="descRadio">Todo aquel que no este unido en la comunidad no podr&aacute; ver el contenido de tu comunidad.</p></td></tr></table></fieldset> 

<fieldset><legend><label for="privada_4" class="tit_lab">S&oacute;lo Miembros/Oculta</label></legend><table><tr><td style="width:18px;padding:0px;margin:0px;"><input name="privada" id="privada_4" value="4"';
  if ($context['COMediTacceso'] == 4) {
    echo ' checked="checked"';
  }
  echo ' type="radio" /></td><td><p class="descRadio">Todo aquel que no este unido en la comunidad no podr&aacute; ver el contenido de tu comunidad. No se mostrar&aacute;n los ultimos temas creados en el centro de comunidades.</p></td></tr></table></fieldset> 
</div></div>
<div style="margin-bottom:8px;">
<div class="titlesCom" onclick="DesplComOps(\'aprobar\',\'acceso\',\'fname\'); return false;" id="dev_aprobar" ><label for="aprobar"><b>Aprobaci&oacute;n de miembros</b></label></div>
<div class="titlesCom2" onclick="DesplComOps2(\'aprobar\'); return false;" id="dov_aprobar" style="display:none;"><label for="lname"><b>Aprobaci&oacute;n de miembros</b></label></div>
<div class="postLabel" style="display:none;" id="div_aprobar">
<fieldset><legend><label for="automatica" class="tit_lab">Automatica</label></legend>
<table><tr><td style="width:18px;padding:0px;margin:0px;"><input name="aprobar" id="automatica" value="0"';
  if (!$context['COMediTaprobar']) {
    echo ' checked="checked"';
  }
  echo ' tabindex="9" type="radio" /></td><td><p class="descRadio">Cuando una persona se une a la comunidad, nadie deber&aacute; aprobarlo.</p></td></tr></table></fieldset>

<fieldset><legend><label for="manual" class="tit_lab">Manual</label></legend><table><tr><td style="width:18px;padding:0px;margin:0px;"><input name="aprobar" id="manual" value="1"';
  if ($context['COMediTaprobar']) {
    echo ' checked="checked"';
  }
  echo ' type="radio" /></td><td><p class="descRadio">Cuando una persona se une a la comunidad, deber&aacute; esperar a que el administrador de tal lo apruebe.</p></td></tr></table></fieldset> </div>
</div>


<div class="titlesCom" onclick="DesplComOps(\'fname\',\'aprobar\',\'acceso\'); return false;" id="dev_fname" ><label for="fname"><b>Permisos</b></label></div>
<div class="titlesCom2" onclick="DesplComOps2(\'fname\'); return false;" id="dov_fname" style="display:none;"><label for="lname"><b>Permisos</b></label></div>
<div class="postLabel" style="display:none;" id="div_fname"><fieldset><legend><label for="permisos_1" class="tit_lab">Posteador</label></legend><table><tr><td style="width:18px;padding:0px;margin:0px;"><input name="rango_default" id="permisos_1" value="3" checked="checked" tabindex="11"';
  if ($context['COMediTpermiso'] == '3') {
    echo ' checked="checked"';
  }
  echo ' type="radio" /></td><td><p class="descRadio">Los usuarios al ingresar en tu comunidad podr&aacute;n comentar y crear temas.</p></td></tr></table></fieldset>
<fieldset><legend><label for="permisos_2" class="tit_lab">Comentador</label></legend><table><tr><td style="width:18px;padding:0px;margin:0px;"><input name="rango_default" id="permisos_2" value="2"';
  if ($context['COMediTpermiso'] == '2') {
    echo ' checked="checked"';
  }
  echo ' type="radio" /></td><td><p class="descRadio">Los usuarios al participar en tu  comunidad s&oacute;lo podr&aacute;n comentar pero no estar&aacute;n habilitados para crear nuevos temas.</p></td></tr></table></fieldset>
<fieldset><legend><label for="permisos_3" class="tit_lab">Visitante</label></legend><table><tr><td style="width:18px;padding:0px;margin:0px;"><input name="rango_default" id="permisos_3" value="4"';
  if ($context['COMediTpermiso'] == '4') {
    echo ' checked="checked"';
  }
  echo ' type="radio" /></td><td>
<p class="descRadio">Los usuarios al participar en tu comunidad no podr&aacute;n comentar ni tampoco crear temas.</p></td></tr></table></fieldset><fieldset><legend class="tit_lab">Nota:</legend><p class="descRadio">
El permiso seleccionado se le asignar&aacute; autom&aacute;ticamente al usuario que se haga miembro, sin embargo, podr&aacute;s modificar el permiso a cada usuario especifico.</p>
</fieldset></div>
...
FROM {$db_prefix}comunidades_categorias", __FILE__, __LINE__);
    ...
    echo '</tr></table><div class="noesta-am" style="width:922px;margin-top:15px;"><a href="' . $boardurl . '/crear-comunidades/">Crea tu comunidad. Es GRATIS, R&Aacute;PIDO Y FACIL</a></div>';
  } else {
    $RegistrosAMostrar = 8;
...
<div class="clearfix"></div>';
    ...
    if ($Res > 0)
      $PagUlt = floor($PagUlt) + 1;
    if ($PagAct > $PagUlt) {
      echo '<div class="noesta" style="width:922px;">Est&aacute; p&aacute;gina no existe.</div>';
    }
    if ($PagAct > $PagUlt) {
    } else {
      if ($PagAct > 1 || $PagAct < $PagUlt) {
        echo '<div class="windowbgpag" style="width:378px;">';
        if ($PagAct > 1) {
          echo '<a href="/comunidades/dir/' . $cat . '/pag-' . $PagAnt . '">&#171; anterior</a>';
        }
        if ($PagAct < $PagUlt) {
          echo '<a href="/comunidades/dir/' . $cat . '/pag-' . $PagSig . '">siguiente &#187;</a>';
        }
      }
      echo '</div>';
    }
