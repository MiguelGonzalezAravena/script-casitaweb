...
function template_before() {
  global $context, $settings, $options, $scripturl, $txt, $modSettings, $no_avatar, $tranfer1, $boardurl;
  ...
  // TO-DO: Seguir arreglando 1
  // Formulario de registro
  echo '
    <div style="width:560px;float:left;"><div class="box_560"><div class="box_title" style="width: 558px;"><div class="box_txt box_560-34">Formulario de registro</div><div class="box_rss"><div class="icon_img"><img src="' . $tranfer1 . '/blank.gif" style="width:16px;height:16px;" border="0" alt="" /></div></div></div>
