...
function template_editsmileys() {
  global $context, $settings, $options, $scripturl, $txt, $modSettings, $tranfer1, $boardurl;
  ...
  <form action="' . $boardurl . '/moderacion/emoticones/editsmileys" method="post" accept-charset="' . $context['character_set'] . '" name="smileyForm" id="smileyForm">
    ...
    echo '
      ...
      <tr class="catbg3">
        <td></td>
        <td>' . $txt['smileys_code'] . '</td>
        <td>' . $txt['smileys_filename'] . '</td>
        <td>' . $txt['smileys_location'] . '</td>
    ...
    foreach ($context['smileys'] as $smiley) {
      echo '
        <tr class="windowbg2">
          <td valign="top">
            <a href="' . $boardurl . '/moderacion/emoticones/modifysmiley;smiley=' . $smiley['id'] . '">
              <img src="' . $tranfer1 . '/emoticones/' . $smiley['filename'] . '" alt="' . $smiley['description'] . '" style="padding: 2px;" id="smiley' . $smiley['id'] . '" />
              <input type="hidden" name="smileys[' . $smiley['id'] . '][filename]" value="' . $smiley['filename'] . '" />
            </a>
          </td>
          <td valign="top" style="font-family: monospace;">' . $smiley['code'] . '</td>
          <td valign="top" class="windowbg">' . $smiley['filename'] . '</td>
          <td valign="top">' . $smiley['location'] . '</td>
          <td valign="top" class="windowbg">
            ' . $smiley['description'] . empty($smiley['sets_not_found']) ? '' : '<br /><span class="smalltext"><b>' . $txt['smileys_not_found_in_set'] . ':</b> ' . implode(', ', $smiley['sets_not_found']) . '</span>', '
          </td>
          <td valign="top">
            <a href="' . $boardurl . '/moderacion/emoticones/modifysmiley;smiley=' . $smiley['id'] . '">' . $txt['smileys_modify'] . '</a>
          </td>
  ...
  echo '
    <form action="' . $boardurl . '/moderacion/emoticones/editsmileys" method="post" accept-charset="' . $context['character_set'] . '" name="smileyForm" id="smileyForm">
      <table border="0" cellspacing="0" cellpadding="4" align="center" width="80%" class="tborder">
        ...
        <tr class="windowbg2">
          <td align="right">
            <b>' . $txt['smiley_preview'] . ':</b>
          </td>
          <td>
            <img src="' . $tranfer1 . '/' . $context['current_smiley']['filename'] . '" id="preview" alt="" />
            (' . $txt['smiley_preview_using'] . ':
            <select name="set" onchange="updatePreview();">';
    ...
    echo '
      ...
      <tr class="windowbg2">
        ...
        <td>
          <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="smiley_code" value="' . $context['current_smiley']['code'] . '" />
        </td>
      </tr>
      <tr class="windowbg2">
        <td align="right">
      ...
      if (empty($context['filenames'])) {
        ...
        echo '<select name="smiley_filename" onchange="updatePreview();">';
      ...
      echo '
            ...
            <tr class="windowbg2">
              ...
              <td>
                <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="smiley_description" value="' . $context['current_smiley']['description'] . '" />
              </td>
            </tr>
            <tr class="windowbg2">
              <td align="right">
...
function template_addsmiley() {
  ...
  echo '
    <form action="' . $boardurl . '/moderacion/emoticones/addsmiley" method="post" accept-charset="' . $context['character_set'] . '" name="smileyForm" id="smileyForm" enctype="multipart/form-data">
      <table border="0" cellspacing="0" cellpadding="4" align="center" width="80%" class="tborder">
        <tr class="titlebg">
  ...
  echo '
      ...
      <table width="80%" cellpadding="4" cellspacing="0" border="0" align="center" class="tborder">
        ...
        <tr class="windowbg2">
          ...
          <td width="60%">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="smiley_code" value="" />
          </td>
        </tr>
        <tr class="windowbg2">
          <td align="right" width="40%">
          ...
          <td width="60%">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="smiley_description" value="" />
          </td>
        </tr>
        <tr class="windowbg2">
          <td align="right" width="40%">
        ...
        <tr class="windowbg">
          <td align="right" colspan="2">
            <input class="login" type="submit" value="' . $txt['smileys_save'] . '" />
          </td>
        </tr>
      </table>
      <input type="hidden" name="sc" value="' . $context['session_id'] . '" />
...
function template_setorder() {
  global $context, $settings, $options, $scripturl,$tranfer1, $txt, $modSettings, $boardurl;

  foreach ($context['smileys'] as $location) {
    echo '
      <br />
      <form action="' . $boardurl . '/moderacion/emoticones/editsmileys" method="post" accept-charset="' . $context['character_set'] . '">
        <table border="0" cellspacing="1" cellpadding="4" align="center" width="80%" class="tborder" style="padding: 1px;">
          ...
          <tr class="windowbg2">
            <td>
              <b>' . (empty($context['move_smiley']) ? $txt['smileys_move_select_smiley'] : $txt['smileys_move_select_destination']) . '...</b>
              <br />';

    foreach ($location['rows'] as $row) {
      if (!empty($context['move_smiley'])) {
        echo '
          <a href="' . $boardurl . '/moderacion/emoticones/setorder;location=' . $location['id'] . ';source=' . $context['move_smiley'] . ';row=' . $row[0]['row'] . ';sesc=' . $context['session_id'] . '">
            <img src="' . $tranfer1 . '/emoticon_select.gif" alt="' . $txt['smileys_move_here'] . '" />
          </a>';
      }
      ...
      foreach ($row as $smiley) {
        if (empty($context['move_smiley'])) {
          echo '
            <a href="' . $boardurl . '/moderacion/emoticones/setorder;move=' . $smiley['id'] . '">
              <img src="' . $tranfer1 . '/emoticones/' . $smiley['filename'] . '" style="padding: 2px; border: 0px solid black;" alt="' . $smiley['description'] . '" />
            </a>';
        } else {
          echo '
            <img src="' . $tranfer1 . '/emoticones/' . $smiley['filename'] . '" style="padding: 2px; border: ' . ($smiley['selected'] ? '2px solid red' : '0px solid black') . ';" alt="' . $smiley['description'] . '" />
            <a href="' . $boardurl . '/moderacion/emoticones/setorder;location=' . $location['id'] . ';source=' . $context['move_smiley'] . ';after=' . $smiley['id'] . ';sesc=' . $context['session_id'] . '" title="' . $txt['smileys_move_here'] . '">
              <img src="' . $tranfer1 . '/emoticon_select.gif" alt="' . $txt['smileys_move_here'] . '" />
            </a>';
        }
      }
    ...
    if (!empty($context['move_smiley'])) {
      echo '
          <a href="' . $boardurl . '/moderacion/emoticones/setorder;location=' . $location['id'] . ';source=' . $context['move_smiley'] . ';row=' . $location['last_row'] . ';sesc=' . $context['session_id'] . '">
            <img src="' . $tranfer1 . '/emoticon_select.gif" alt="' . $txt['smileys_move_here'] . '" />
          </a>';
    }
