    ...
    <div class="tborder">
      <form action="' . $scripturl . '?' . $urlSep . '=membergroups;sa=add;generalgroup" method="post" accept-charset="' . $context['character_set'] . '" style="margin: 0;">
        <table width="100%" cellpadding="2" cellspacing="1" border="0">
          <tr class="titlebg">
            <td colspan="4" style="padding: 4px;">Rangos epeciales</td>
          </tr>
          <tr style="background: #FFC703; border-bottom: 3px solid #BF8A01; font-size: 11px;">
            <td width="42%">Rango</td>
            <td width="12%" align="center">Imagen</td>
  ...
  foreach ($context['groups']['regular'] as $group) {
    echo '
      <tr>
        <td class="windowbg2">
          ' . 
          (empty($group['color']) ? ($group['can_search'] ? $group['link'] : $group['name']) : '<span style="color: ' . $group['color'] . '">' . ($group['can_search'] ? $group['link'] : $group['name']) . '</span>') .
        ...
        <td class="windowbg2" align="center">
          <a href="' . $scripturl . '?' . $urlSep . '=membergroups;sa=edit;group=' . $group['id'] . '">' . $txt['membergroups_modify'] . '</a>
        </td>
      </tr>';
  }
  ...
  echo '
          <tr class="windowbg">
            <td colspan="4" align="right" style="padding-top: 1ex; padding-bottom: 2ex;">
              <input class="login" type="submit" value="' . $txt['membergroups_add_group'] . '" style="margin: 4px;" />
            </td>
          </tr>
        </table>
    ...
    <div class="tborder">
      <form action="' . $scripturl . '?' . $urlSep . '=membergroups;sa=add" method="post" accept-charset="' . $context['character_set'] . '" style="margin: 0;">
        <table width="100%" border="0" cellpadding="2" cellspacing="1">
          <tr class="titlebg">
            <td colspan="5" style="padding: 4px;">Rangos por conteo de puntos</td>
          </tr>
          <tr style="background: #FFC703; border-bottom: 3px solid #BF8A01; font-size: 11px;">
            <td width="42%">Rango</td>
            <td width="12%" align="center">Imagen</td>
            <td width="10%" align="center">' . $txt['membergroups_members_top'] . '</td>
            <td width="12%" align="center">Cantidad de puntos</td>
            <td width="10%" align="center">' . $txt[17] . '</td>
          </tr>';
...
function template_new_group() {
  ...
  if ($context['undefined_group']) {
    echo '
      <tr class="windowbg2">
        <th align="right">
          <label for="postgroup_based_check">' . $txt['membergroups_edit_post_group'] . ':</label>
        </th>
        <td>
  ...
  echo '
    <tr class="windowbg2">
      <th align="right" valign="top" style="padding-top: 1em;">
        ...
        ' . ($context['post_group'] ? '<div class="smalltext" style="font-weight: normal">' . $txt['membergroups_new_board_post_groups'] . '</div>' : '') . '
      </th>
      <td>
  ...
  foreach ($context['boards'] as $board) {
    echo '
      <div style="margin-left: ' . $board['child_level'] . 'em;">
        <input type="checkbox" name="boardaccess[]" id="boardaccess_' . $board['id'] . '" value="' . $board['id'] . '" ' . ($board['selected'] ? ' checked="checked" disabled="disabled"' : '') . ' class="check" />
        <label for="boardaccess_' . $board['id'] . '">' . $board['name'] . '</label>
      </div>';
  }

  echo '
            <br />
            <input type="checkbox" id="checkall_check" class="check" onclick="invertAll(this, this.form, \'boardaccess\');" />
            <label for="checkall_check">
              <i>' . $txt[737] . '</i>
            </label>
          </fieldset>
        </td>
      ...
      <tr class="windowbg2">
        ...
        <br />
        <input class="login" type="submit" value="' . $txt['membergroups_add_group'] . '" /></td>
      </tr>
    </table>';
...
function template_edit_group() {
  ...
  echo '
    <form action="' . $scripturl . '?' . $urlSep . '=membergroups;sa=edit;group=' . $context['group']['id'] . '" method="post" accept-charset="' . $context['character_set'] . '" name="groupForm" id="groupForm">
      <table width="95%" border="0" cellspacing="0" cellpadding="3" class="tborder" align="center">
        ...
        <tr class="windowbg2">
          <th align="right" width="50%">
            <label for="group_name_input">Rango:</label>
          </th>
          <td>
  ...
  if ($context['group']['allow_post_group']) {
    echo '
        <tr class="windowbg2">
          <th align="right">
            <label for="post_group_check">Este rango est&aacute; basado en el conteo de puntos:</label>
          </th>
          <td>
            <input type="checkbox" name="post_group" id="post_group_check" value="1"' . ($context['group']['is_post_group'] ? ' checked="checked"' : '') . ' onclick="swapPostGroup(this.checked);" class="check" />
          </td>
        </tr>
        <tr class="windowbg2">
          <th align="right" id="min_posts_text">
            <label for="min_posts_input">Cantidad de puntos:</label>
          </th>
          <td>
  ...
  echo '
        <tr class="windowbg2">
          <th align="right" style="padding-top: 1em;">
            <label for="star_image_input">Imagen:</label>
          </th>
          <td>
            <input type="text" name="star_image" id="star_image_input" value="' . $context['group']['star_image'] . '" size="20" />
            <img id="star_preview" src="' . $tranfer1 . '/' . $context['group']['star_image'] . '" alt="*" />
          </td>
        </tr>';
    ...
    echo '
        <tr class="windowbg2">
          <th align="right" valign="top">
            ' . $txt['membergroups_new_board'] . ':
            ' . ($context['group']['is_post_group'] ? '<div class="smalltext" style="font-weight: normal">' . $txt['membergroups_new_board_post_groups'] . '</div>' : '') . '
          </th>
          <td valign="top">
            <fieldset id="visible_boards">
              <legend>
                <a href="javascript:void(0);" onclick="document.getElementById(\'visible_boards\').style.display = \'none\';document.getElementById(\'visible_boards_link\').style.display = \'block\'; return false;">' . $txt['membergroups_new_board_desc'] . '</a>
              </legend>';

    foreach ($context['boards'] as $board) {
      echo '
        <div style="margin-left: ' . $board['child_level'] . 'em;">
          <input type="checkbox" name="boardaccess[]" id="boardaccess_' . $board['id'] . '" value="' . $board['id'] . '" ' . ($board['selected'] ? ' checked="checked"' : '') . ' class="check" />
          <label for="boardaccess_' . $board['id'] . '">' . $board['name'] . '</label>
        </div>';
    }
  ...
  echo '
        <tr class="windowbg2">
          <td colspan="2" align="right" style="padding-top: 1ex;">
            <input class="login" type="submit" name="submit" value="' . $txt['membergroups_edit_save'] . '" />
            ' . ($context['group']['allow_delete'] ? '<input class="login" type="submit" name="delete" value="' . $txt['membergroups_delete'] . '" onclick="return confirm(\'' . $txt['membergroups_confirm_delete'] . '\');" />' : '') . '
          </td>
        </tr>
      </table>
      <input type="hidden" name="sc" value="' . $context['session_id'] . '" />
...
function template_group_members() {
  global $context, $settings, $options, $scripturl, $txt, $urlSep, $tranfer1;
  ...
  echo '
    <form action="' . $scripturl . '?' . $urlSep . '=membergroups;sa=members;group=' . $context['group']['id'] . '" method="post" accept-charset="' . $context['character_set'] . '">
      <table width="90%" cellpadding="4" cellspacing="1" border="0" class="bordercolor" align="center">
        ...
        <tr class="titlebg">
          <td>
            <a href="' . $scripturl . '?' . $urlSep . '=membergroups;sa=members;start=' . $context['start'] . ';sort=name' . ($context['sort_by'] == 'name' && $context['sort_direction'] == 'up' ? ';desc' : '') . ';group=' . $context['group']['id'] . '">' . $txt[68] . ($context['sort_by'] == 'name' ? ' <img src="' . $tranfer1 . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '') . '</a>
          </td>
          <td>
            <a href="' . $scripturl . '?' . $urlSep . '=membergroups;sa=members;start=' . $context['start'] . ';sort=email' . ($context['sort_by'] == 'email' && $context['sort_direction'] == 'up' ? ';desc' : '') . ';group=' . $context['group']['id'] . '">' . $txt[69] . ($context['sort_by'] == 'email' ? ' <img src="' . $tranfer1 . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '') . '</a>
          </td>
          <td>
            <a href="' . $scripturl . '?' . $urlSep . '=membergroups;sa=members;start=' . $context['start'] . ';sort=active' . ($context['sort_by'] == 'active' && $context['sort_direction'] == 'up' ? ';desc' : '') . ';group=' . $context['group']['id'] . '">' . $txt['attachment_manager_last_active'] . ($context['sort_by'] == 'active' ? ' <img src="' . $tranfer1 . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '') . '</a>
          </td>
          <td>
            <a href="' . $scripturl . '?' . $urlSep . '=membergroups;sa=members;start=' . $context['start'] . ';sort=registered' . ($context['sort_by'] == 'registered' && $context['sort_direction'] == 'up' ? ';desc' : '') . ';group=' . $context['group']['id'] . '">' . $txt[233] . ($context['sort_by'] == 'registered' ? ' <img src="' . $tranfer1 . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '') . '</a>
          </td>
          <td', empty($context['group']['assignable']) ? ' colspan="2"' : '', '>
            <a href="' . $scripturl . '?' . $urlSep . '=membergroups;sa=members;start=' . $context['start'] . ';sort=posts' . ($context['sort_by'] == 'posts' && $context['sort_direction'] == 'up' ? ';desc' : '') . ';group=' . $context['group']['id'] . '">' . $txt[21] . ($context['sort_by'] == 'posts' ? ' <img src="' . $tranfer1 . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '') . '</a>
          </td>';
    ...
    if (!empty($context['group']['assignable'])) {
      echo '
        <td align="center" width="4%">
          <input type="checkbox" name="rem[]" value="' . $member['id'] . '" class="check" />
        </td>';
    }
    ...
    echo '
      <tr class="titlebg">
        <td colspan="6" align="right">
          <input class="login" type="submit" name="remove" value="' . $txt['membergroups_members_remove'] . '!" style="font-weight: normal;" />
        </td>
      </tr>';
  }
      ...
      <table width="90%" cellpadding="4" cellspacing="0" border="0" class="tborder" align="center">
        ...
        <tr class="windowbg2">
          ...
          <td align="left">
            ...
            <a href="' . $scripturl . '?' . $urlSep . '=findmember;input=toAdd;quote;sesc=' . $context['session_id'] . '" onclick="return reqWin(this.href, 350, 400);"><img src="' . $tranfer1 . '/icons/assist.gif" alt="' . $txt['find_members'] . '" /></a>
          </td>
        </tr>
        <tr class="windowbg2">
          <td colspan="2" align="center">
            <input class="login" type="submit" name="add" value="' . $txt['membergroups_members_add'] . '" />
          </td>
        </tr>
      </table>';
  }
  ...
  echo '
        <tr class="windowbg2">
          <td align="right" colspan="2">
            <input class="login" type="submit" name="save_settings" value="' . $txt['membergroups_settings_submit'] . '" />
          </td>
        </tr>
      </table>
      <input type="hidden" name="sc" value="' . $context['session_id'] . '" />
