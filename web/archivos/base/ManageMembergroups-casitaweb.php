...
function template_new_group()
{
	...
	echo '<br />
					...
					<td colspan="2" align="right"><br /><input class="login" type="submit" value="', $txt['membergroups_add_group'], '" /></td>
				</tr>
			</table>';
	if ($context['undefined_group'])
	{
...
function template_edit_group()
{
	...
	echo '
		<form action="', $scripturl, '?' . $urlSep . '=membergroups;sa=edit;group=', $context['group']['id'], '" method="post" accept-charset="', $context['character_set'], '" name="groupForm" id="groupForm">
			<table width="95%" border="0" cellspacing="0" cellpadding="3" class="tborder" align="center">
				...
				<tr class="windowbg2">
					<th align="right" width="50%"><label for="group_name_input">Rango:</label></th>
	...
	if ($context['group']['allow_post_group'])
		echo '
				<tr class="windowbg2">
					<th align="right"><label for="post_group_check">Este rango esta basado en el conteo de puntos:</label></th>
				...
				<tr class="windowbg2">
					<th align="right" id="min_posts_text"><label for="min_posts_input">Cantidad de puntos:</label></th>
	...
	echo '
				<tr class="windowbg2">
					...
					<td>			<input type="text" name="star_image" id="star_image_input" value="', $context['group']['star_image'], '" size="20" />
	...
	echo '
				<tr class="windowbg2">
					<td colspan="2" align="right" style="padding-top: 1ex;">
						<input class="login" type="submit" name="submit" value="', $txt['membergroups_edit_save'], '" />', $context['group']['allow_delete'] ? '
						<input class="login" type="submit" name="delete" value="' . $txt['membergroups_delete'] . '" onclick="return confirm(\'' . $txt['membergroups_confirm_delete'] . '\');" />' : '', '
					</td>
				</tr>
			</table>
			<input type="hidden" name="sc" value="', $context['session_id'], '" />
