...
<table>';
  if (!empty($context['move_board'])) {
    echo '<tr height="30"><td><center><b class"size11" style="color:red;">', $context['move_title'], ' [<a href="', $scripturl, '?' . $urlSep . '=manageboards">', $txt['mboards_cancel_moving'], '</a>]</b></center></td></tr>';
  }
...
<form action="', $scripturl, '?' . $urlSep . '=manageboards;sa=board2" method="post" accept-charset="', $context['character_set'], '">
  ...
  if (isset($context['board']['is_new'])) {
    ...
    echo '<select id="order" name="placement" onchange="this.form.boardOrder.disabled = this.options[this.selectedIndex].value == \'\';">
  ...
  echo '
                ...
                <td>
                  <b class="size11">Enlace de categor&iacute;a:</b><br /><br />
                </td>
                <td valign="top" align="right">
                ...
                <td valign="top">
                  <b class="size11">', $txt['mboards_groups'], '</b><br /><br />
                </td>
                <td valign="top" align="right">';
...
<div class="box_rss"><img src="' . $tranfer1 . '/blank.gif" style="width: 16px; height: 16px;" border="0"></div></div></div>
  ...
  if ($context['can_change_permissions']) {
    echo '
      <tr class="windowbg2">
        <td width="50%" align="right" valign="top"><b class="size11">Grupos autorizados para administrar categor&iacute;as:</b></td>
        <td width="50%">';
  ...
  echo '<tr>
        <th width="50%" align="right" class="size11"><label for="recycle_enable_check">', $txt['recycle_enable'], '</label> <span style="font-weight: normal;"></span>:</th>
        <td>
