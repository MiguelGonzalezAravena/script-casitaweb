...
function template_main() {
  ...
  if ($context['id_user'] <> $context['user']['id']) {
    ...
    $VarCausa = '
      <b class="size11">Causa:</b><br />
      <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="causa" value=""tabindex="2" style="width: 138px;" maxlength="70" />
      <span id="MostrarError5" class="capsprot">Debes agregar la causa por la cual moderas este post.</span>
      <br />';
  } else {
    $VarJSuna = '';
    $VarJSdos = '';
      ...
      <script type="text/javascript">
        ...
        function confirmleave() {
          if (confirm && ($(\'input[name=titulo]\').val() || $(\'textarea[name=contenido]\').val())) {
            return "Este post no fue editado y se perder&aacute; lo que editaste.";
          }
        }
      ...
      <div style="margin-bottom: 8px; margin-right: 8px; float: left; width: 235px">
        <div class="box_235">
          ...
          <div class="windowbg" border="0" style="width: 225px; padding: 4px; font-family: arial;">
            ...
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />Contenido descriptivo.
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />T&iacute;tulo descriptivo.
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />Agregar im&aacute;genes sobre el post.
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />Noticias con fuente.
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />No excederse en may&uacute;sculas.
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />No t&iacute;tulo llamativo.
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />No spam.
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />No gore o asqueros.
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />No insultos o malos tratos.
            <br />
            <img src="' . $tranfer1 . '/icons/si.png" class="png" alt="" width="16px" height="16px" />No pornograf&iacute;a.
            <br />
            <br />
    ...
    if ($modSettings['smiley_enable']) {
        ...
        while ($row = mysqli_fetch_assoc($existe)) {
          echo '<span style="cursor: pointer;" onclick="replaceText(\' ', $row['code'], '\', document.forms.editarPost.editorCW); return false;"><img src="' . $tranfer1 . '/emoticones/' . $row['filename'] . '" align="bottom" alt="' . $row['description'] . '" title="' . $row['description'] . '" class="png" /></span> ';
        }
    ...
    echo '
      ...
      <br />
      <input style="width: 415px;' . $col . '" maxlength="128" value="' . $pal . '" name="tags" tabindex="4" type="text" onfocus="foco(this);" onblur="no_foco(this);" />
      <br />
      <span class="size9">
