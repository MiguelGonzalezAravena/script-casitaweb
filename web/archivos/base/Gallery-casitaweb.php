...
ORDER BY p.ID_CAT DESC", __FILE__, __LINE__);
    ...
    if (!empty($skasdasdbsddd)) {
      echo '<div class="hrs"></div><b>Dieron puntos a esta imagen:</b> ';
      echo join(', ', $userdasd);
    }
  }
...
<div style="clear: left;"></div> <div style="margin-bottom:8px;margin-top:8px;">';
  ...
  if ($context['sin_coment']) {
    echo '<div class="icon_img" style="float: left; margin-right: 5px;"><a href="/rss/pic-comment/' . $context['gallery_pic']['ID_PICTURE'] . '"><img alt="" src="' . $tranfer1 . '/icons/cwbig-v1-iconos.gif?v3.2.3" style="cursor:pointer;margin-top:-352px;display:inline;" /></a></div>';
  }
...
<div style="float:left;">';
    ...
    $diames2 = date('j', $coment['fecha']);
    $mesano2 = date('n', $coment['fecha']) - 1;
    $ano2 = date('Y', $coment['fecha']);
    $seg2 = date('s', $coment['fecha']);
