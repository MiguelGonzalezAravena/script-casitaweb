...
function template_view_members() {
  global $context, $settings, $options, $txt, $scripturl, $boardurl, $urlSep;
  ...
  if (empty($context['members'])) {
    echo '
      <tr>
        <td colspan="8">
          <b class="size11">No se encontraron resultados.</b>
          <div class="hrs"></div>
        </td>
      </tr>';
  } else {
    foreach ($context['members'] as $member) {
      echo '
        <tr>
          ...
          <td>
            <a href="http://lacnic.net/cgi-bin/lacnic/whois?query=' . $member['ip'] . '">' . $member['ip'] . '</a>
          </td>
          <td align="center">
...
function template_search_members() {
  ...
  echo '
    <form action="' . $scripturl . '?' . $urlSep . '=viewmembers" method="post" accept-charset="' . $context['character_set'] . '">
      ...
      <table width="100%" cellpadding="4" cellspacing="0" class="windowbg">
        ...
        <tr>
          ...
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="mem_id" value="" size="6" />
          </td>
          <th align="right">' . $txt[35] . ':</th>
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="membername" value="" />
          </td>
        </tr>
        <tr>
          ...
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="age" value="" size="6" />
          </td>
          <th align="right">' . $txt['email_address'] . ':</th>
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="email" value="" />
          </td>
        </tr>
        <tr>
          ...
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="posts" value="" size="6" />
          </td>
          <th align="right">' . $txt[96] . ':</th>
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="website" value="" />
          </td>
        </tr>
        <tr>
          ...
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="reg_date" value="" />
            <span class="smalltext">' . $txt['date_format'] . '</span>
          </td>
          <th align="right">' . $txt[227] . ':</th>
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="location" value="" />
          </td>
        </tr>
        <tr>
          ...
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="last_online" value="" />
            <span class="smalltext">' . $txt['date_format'] . '</span>
          </td>
          <th align="right">' . $txt['ip_address'] . ':</th>
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="ip" value="" />
          </td>
        </tr>
        <tr>
          ...
          <td align="left" colspan="2">
            <label for="gender-0">
              <input type="checkbox" name="gender[]" value="0" id="gender-0" checked="checked" class="check" />
              ' . $txt['undefined_gender'] . '
            </label>
            &nbsp;&nbsp;
            <label for="gender-1">
              <input type="checkbox" name="gender[]" value="1" id="gender-1" checked="checked" class="check" />
              ' . $txt[238] . '
            </label>
            &nbsp;&nbsp;
            <label for="gender-2">
              <input type="checkbox" name="gender[]" value="2" id="gender-2" checked="checked" class="check" />
              ' . $txt[239] . '
            </label>
          </td>
          <th align="right">' . $txt['messenger_address'] . ':</th>
          <td align="left">
            <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="messenger" value="" />
          </td>
        </tr>
        <tr>
          <th align="right">' . $txt['activation_status'] . ':</th>
          <td align="left" colspan="2">
            <label for="activated-0">
              <input type="checkbox" name="activated[]" value="1" id="activated-0" checked="checked" class="check" />
              ' . $txt['activated'] . '
            </label>
            &nbsp;&nbsp;
            <label for="activated-1">
              <input type="checkbox" name="activated[]" value="0" id="activated-1" checked="checked" class="check" />
              ' . $txt['not_activated'] . '
            </label>
          </td>
        </tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" class="tborder" style="margin-top: 2ex;">
      <tr class="catbg3">
        <td colspan="2" height="28">
          <b>' . $txt['member_part_of_these_membergroups'] . ':</b>
        </td>
      </tr>
      <tr>
  ...
  echo '
        <tr class="windowbg2">
          ...
          <td align="center">
            <input type="checkbox" onclick="invertAll(this, this.form, \'membergroups[1]\');" checked="checked" class="check" />
          </td>
          <td align="center">
            <input type="checkbox" onclick="invertAll(this, this.form, \'membergroups[2]\');" checked="checked" class="check" />
          </td>
        </tr>
      </table>
    </td>
  ...
  echo '
      ...
      <div align="center" style="margin: 2ex;">
        <input class="login" type="submit" value="' . $txt['182'] . '" />
      </div>
    </form>';
}
...
function template_admin_browse() {
  ...
  echo '
    <form action="' . $scripturl . '?' . $urlSep . '=viewmembers" method="post" accept-charset="' . $context['character_set'] . '" name="postForm" id="postForm">
  ...
  echo '
      <td>
        <input type="checkbox" class="check" onclick="invertAll(this, this.form, \'todo\');" />
      </td>
    </tr>';
  ...
  if (empty($context['members'])) {
    ...
    foreach ($context['members'] as $member) {
      ...
      <tr>
        ...
        <td class="windowbg2">' . $member['ip'] . '</td>
    ...
    if (!empty($context['available_filters']) && count($context['available_filters']) > 1) {
      ...
      foreach ($context['available_filters'] as $filter) {
        echo '
          <option value="' . $filter['type'] . '">' . $filter['desc'] . ' - ' . $filter['amount'] . ' ' . ($filter['amount'] == 1 ? $txt['user'] : $txt['users']) . '</option>';
      }

      echo '
        </select>
        <noscript><input class="login" type="submit" value="' . $txt[161] . '" name="filter" /></noscript>';
    }
    ...
    if (!empty($context['show_filter']) && !empty($context['available_filters'])) {
      echo '
        <span class="smalltext">
          <b>' . $txt['admin_browse_filter_show'] . ':</b>
          ' . $context['available_filters'][0]['desc'] . '
        </span>';
    }
    ...
    echo '
                ...
                <noscript><input class="login" type="submit" value="' . $txt[161] . '" /></noscript>
                ...
                ' . ($context['sort_direction'] == 'up' ? '<input type="hidden" name="desc" value="1" />' : '') . '
              </td>
            </tr>
          </table>
        </td>
  ...
  if ($context['num_members'] > 20) {
    echo '
      <form action="' . $scripturl . '?' . $urlSep . '=viewmembers" method="post" accept-charset="' . $context['character_set'] . '" name="postFormOutstanding" id="postFormOutstanding" onsubmit="return onOutstandingSubmit();">
        <table border="0" cellspacing="0" cellpadding="4" align="center" width="100%" class="tborder">
          ...
          <tr class="windowbg2">
            ...
            <td align="left">
              <input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="time_passed" value="14" maxlength="4" size="3" />
          ...
          <tr class="windowbg2">
            ...
            <td align="left">
              <select name="todo">
                ' . ($context['browse_type'] == 'activate' ? '<option value="ok">' . $txt['admin_browse_w_activate'] . '</option>' : '') . '
                ...
                ' . ($context['browse_type'] == 'activate' ? '' : '<option value="require_activation">' . $txt['admin_browse_w_approve_require_activate'] . '</option>') . '
                ...
                ' . ($context['browse_type'] == 'activate' ? '<option value="remind">' . $txt['admin_browse_w_remind'] . '</option>' : '') . '
              </select>
            </td>
          </tr>
          <tr class="windowbg2">
            <td align="center" colspan="2">
              <input class="login" type="submit" value="' . $txt['admin_browse_outstanding_go'] . '" />
              <input type="hidden" name="type" value="' . $context['browse_type'] . '" />
              <input type="hidden" name="sort" value="' . $context['sort_by'] . '" />
              <input type="hidden" name="start" value="' . $context['start'] . '" />
              <input type="hidden" name="orig_filter" value="' . $context['current_filter'] . '" />
