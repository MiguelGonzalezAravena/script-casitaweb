...
<tr class="titlebg">';
	...
	if (empty($context['members']))
		echo'<tr><td colspan="8"><b class="size11">No se encontraron resultados.-</b><div class="hrs"></div></td></tr>';
	else
	{
...
function template_search_members(){global $context, $settings, $options, $scripturl, $txt,$urlSep;

	echo '<form action="/index.php?'.$urlSep.'=viewmembers" method="post" accept-charset="', $context['character_set'], '">
			...
			<tr class="titlebg">
				<td colspan="5">', $txt['search_for'], ':</td>
						...
						<tr>
							...
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="mem_id" value="" size="6" /></td>
							<th align="right">', $txt[35], ':</th>
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="membername" value="" /> </td>
						</tr><tr>
							...
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="age" value="" size="6" /></td>
							<th align="right">', $txt['email_address'], ':</th>
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="email" value="" /></td>
						</tr><tr>
							...
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="posts" value="" size="6" /></td>
							<th align="right">', $txt[96], ':</th>
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="website" value="" /></td>
						</tr><tr>
							...
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="reg_date" value="" /> <span class="smalltext">', $txt['date_format'], '</span></td>
							<th align="right">', $txt[227], ':</th>
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="location" value="" /></td>
						</tr><tr>
							...
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="last_online" value="" /> <span class="smalltext">', $txt['date_format'], '</span></td>
							<th align="right">', $txt['ip_address'], ':</th>
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="ip" value="" /></td>
						</tr><tr>
							...
							<td align="left"><input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="messenger" value="" /></td>
						</tr><tr>
		...
		<div align="center" style="margin: 2ex;"><input class="login" type="submit" value="', $txt['182'], '" /></div>
	</form>';
}
...
function template_admin_browse(){
	...
	echo '
	<form action="/index.php?'.$urlSep.'=viewmembers" method="post" accept-charset="', $context['character_set'], '" name="postForm" id="postForm">
	...
	{
		echo '
	<form action="/index.php?'.$urlSep.'=viewmembers" method="post" accept-charset="', $context['character_set'], '" name="postFormOutstanding" id="postFormOutstanding" onsubmit="return onOutstandingSubmit();">
		<table border="0" cellspacing="0" cellpadding="4" align="center" width="100%" class="tborder">
			...
			<tr class="windowbg2">
				...
				<td align="left">
					<input type="text" onfocus="foco(this);" onblur="no_foco(this);" name="time_passed" value="14" maxlength="4" size="3" /> ', $txt['admin_browse_outstanding_days_2'], '.
				</td>
			</tr>
			<tr class="windowbg2">
				<td align="left" width="50%">
