...
echo'</tbody></table><div style="clear: left;"></div>';
...
<div width="160px" style="float:left;width:155px;"><div style="float: left; margin-bottom:8px;" class="img_aletat"><div class="box_title" style="width: 155px;"><div class="box_txt img_aletat">Publicidad</div><div class="box_rss"><img src="'.$tranfer1.'/blank.gif" style="width: 16px; height: 16px;" border="0" alt="" /></div></div>
...
if($PagAct>$PagUlt){echo'</div><div style="clear: left;"></div><div class="noesta" style="width:922px;">No tenes ning&uacute;na imagen favorita.</div>';}else{
    
echo'
<table class="linksList" style="width:757px;">
<thead align="center">
<th style="text-align:left;">Imagenes Favoritas</th>
<th>Creada Por</th>
<th>Puntos</th>
<th>Enviar</th>
<th>Eliminar</th></tr></thead><tbody>';
...
<td><a title="Enviar a amigo" href="/enviar-a-amigo/imagen-'.$dat['ID_TOPIC'].'"><img alt="" src="'.$tranfer1.'/icons/icono-enviar-mensaje.gif" height="16px" width="16px" /></a></td>

<td><span id="imgel_'.$dat['id'].'"><a href="#" onclick="return del_favoritos(\''.$dat['id'].'\');" title="Eliminar favorito"><img alt="" src="'.$tranfer1.'/eliminar.gif" height="10px" width="10px"></a></span><span id="imgerr_'.$dat['id'].'" style="display:none;"></span><span id="imgerrs_'.$dat['id'].'" style="display:none;"><img alt="" src="'.$tranfer1.'/eliminar.gif" height="10px" width="10px"></span></td>
</tr>';}
...
<div width="160px" style="float:left;width:155px;"><div style="float: left; margin-bottom:8px;" class="img_aletat"><div class="box_title" style="width: 155px;"><div class="box_txt img_aletat">Publicidad</div><div class="box_rss"><img src="'.$tranfer1.'/blank.gif" style="width: 16px; height: 16px;" border="0" alt="" /></div></div><div class="windowbg" style="width: 147px; padding: 4px;" align="center">';anuncio_160x600();echo'</div></div></div>';}}

else{echo'</div><div style="clear: left;"></div><div class="noesta" style="width:922px;">No tenes ning&uacute;na imagen favorita.</div>';}}
