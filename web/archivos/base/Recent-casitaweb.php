  ...
  <div style="float:left;height:auto;margin-right:8px;">
    <div class="ultimos_postsa" style="margin-bottom:4px;">
      <div class="box_title" style="width:378px;">
        ...
        <div class="box_rss"><a href="/rss/ultimos-post/">
            <div style="height: 16px; width: 16px; cursor: pointer;" class="feed png"><img alt=""
                src="<?php echo $tranfer1; ?>/espacio.gif" class="png" height="16px" width="16px" /></div>
          </a></div>
      </div>
...
?>
        <div class="postENTrysticky"
          style="background-color: <?php if (empty($sticky['color']) || $sticky['color'] == '0' || $sticky['color'] == '#000000') { ?>#FFFFCC <?php } else { echo $sticky['color']; } ?>;">
          <a href="<?php echo $boardurl; ?>/post/<?php echo $sticky['id']; ?>/<?php echo $sticky['description']; ?>/<?php echo urls($sticky['titulo']); ?>.html"
            target="_self" title="<?php echo $sticky['titulo']; ?>"
            class="categoriaPost <?php echo $sticky['description']; ?>"><?php echo achicars($sticky['titulo']); ?></a>
        </div>
        <?php }
  }
  ...
  if ($context['PagAct'] > $context['PagUlt']) {
    ...
    foreach ($context['posts'] as $posts) { ?>
        <div class="postENTry"><a
            href="<?php echo $boardurl; ?>/post/<?php echo $posts['id']; ?>/<?php echo $posts['description']; ?>/<?php echo urls($posts['titulo']); ?>.html"
            target="_self" title="<?php echo $posts['titulo']; ?>"
            class="categoriaPost <?php echo $posts['description']; ?>"><?php echo achicars($posts['titulo']); ?></a>
        </div> <?php }
  } ?> <div class="clearBoth"></div>
      </div>

      <?php if ($context['PagAct'] > $context['PagUlt']) {} else { ?>
      <?php if ($context['PagAct'] > 1 || $context['PagAct'] < $context['PagUlt']) { ?>
      <div class="windowbgpag" style="width:378px;">
        <?php
    if (empty($context['catccdd'])) {
      if ($context['PagAct'] > 1) {
?> <a href="/pag-<?php echo $context['PagAnt']; ?>">&#171; anterior</a> <?php }

      if ($context['PagAct'] < $context['PagUlt']) { ?> <a href="/pag-<?php echo $context['PagSig']; ?>">siguiente
          &#187;</a> <?php }
    } else {
      if ($context['PagAct'] > 1) { ?> <a
          href="/categoria/<?php echo $context['catccdd']; ?>/pag-<?php echo $context['PagAnt']; ?>">&#171; anterior</a> <?php }
      if ($context['PagAct'] < $context['PagUlt']) { ?> <a
          href="/categoria/<?php echo $context['catccdd']; ?>/pag-<?php echo $context['PagSig']; ?>">siguiente
          &#187;</a> <?php }
    } ?><div class="clearBoth"></div>
      </div> <?php } } ?>
    </div>
  ...
  <div style="float:left;margin:0px;padding:0px;height:90px;margin-bottom:8px;" align="center"><a href="/chat/"
      target="_blank"><img alt="" src="<?php echo $tranfer1; ?>/sala-chat.gif" width="534px" height="90px" /></a></div>

  <div style="float:left;margin-right:8px;">
    <div style="margin-bottom: 8px; width: 363px;">
      <ul class="buscadorPlus">
        <li id="gb" class="activo" onclick="elegir('google')">Google</li>
        <li id="cwb" onclick="elegir('casitaweb')">CasitaWeb!</li>
        <div class="clearBoth"></div>
      </ul>
      <div class="clearBoth"></div>
      <div style="margin-top: -1px;clear:both;">
        <form style="margin: 0px; padding: 0px;" action="/buscar.php" method="get"
          accept-charset="<?php echo $context['character_set']; ?>"><input type="text" name="q" id="q" class="ibuscador"
            style="height:32px;" /><input onclick="return errorrojos(this.form.q.value);" alt="" class="bbuscador png"
            title="Buscar" value=" " type="submit" align="top" style="height:34px;" /><input name="buscador_tipo"
            value="g" checked="checked" type="hidden" /></form>
      </div>
    </div>

    <?php if (!empty($modSettings['radio'])) {
    if ($modSettings['radio'] == '1') { ?> <div class="act_comments">
      <div class="box_title" style="width:361px;">
        <div class="box_txt ultimos_comments">CasitaWeb! - Radio</div>
      ...
      <div class="windowbg" style="padding:4px;width:353px;margin-bottom:8px;">
        <center>
          <div class="stream">
            ...
            <span id="escuchando" style="display:none;"><img src="<?php echo $tranfer1; ?>/icons/microfono.png"
                alt="" /> <a href="/chat/" id="cc_stream_info_song"></a><br /></span>
            <span id="linea"><img src="<?php echo $tranfer1; ?>/icons/microfono.png" alt="" style="display:none;"
                id="imgmic" /><img src="<?php echo $tranfer1; ?>/icons/cargando.gif" id="imgcar" alt="" /> <span
                style="font-weight:bold;" id="enlinea"></span></span>
            <script language="javascript" type="text/javascript"
              src="http://cp.internet-radio.org.uk/system/streaminfo.js"></script>
            <script language="javascript" type="text/javascript"
              src="http://cp.internet-radio.org.uk/js.php/camilo62/streaminfo/rnd0"></script>
            <object type="application/x-shockwave-flash" data="http://fmcasita.net/utilidades/player_mp3_maxi.swf"
              width="266" height="20">
          ...
          <img alt="" src="<?php echo $tranfer1; ?>/icons/radio-cw.gif" /> <b class="size11">Ir a <a target="_blank"
              href="http://fmcasita.net">FMcasita.net</a> - Radio oficial de CasitaWeb!</b>
        </center>
      </div>
    </div>
    ...
    <div class="act_comments">
      ...
      <div class="windowbg" style="padding:4px;width:353px;margin-bottom:8px;">
        <center>
          ...
          <br /><img alt="" src="<?php echo $tranfer1; ?>/icons/radio-cw.gif" /> <b class="size11">Ir a <a
              target="_blank" href="http://perdidosenbabylon.com">Perdidos en babylon!</a> - Web oficial<br /><img
              alt="" src="http://fmcasita.net/utilidades/2.png" /> <a href="mms://201.212.0.128/horaprima">Escuchar en
              Windows media player</a></b>
        </center>
      </div>
    </div>
    <?php }
    ...
    <div class="act_comments">
      <div class="box_title" style="width:361px;">
        ...
        <div class="box_rss">
          <div style="height: 16px; width: 16px; cursor: pointer;" class="actualizarComents png"><img alt="Actualizar"
              onclick="actualizar_comentarios(); return false;" src="<?php echo $tranfer1; ?>/espacio.gif" class="png"
  ...
  foreach ($context['post_semana'] as $postssssss) { ?>
        <b><?php echo $conanto; ++$conanto; ?>.</b>
          <a href="<?php echo $boardurl; ?>/post/<?php echo $postssssss['ID_TOPIC']; ?>/<?php echo $postssssss['description']; ?>/<?php echo urls($postssssss['subject']); ?>.html"
          title="<?php echo $postssssss['subject']; ?>"><?php echo achicars($postssssss['subject']); ?></a>&nbsp;(<span
          title="<?php echo $postssssss['num_posts']; ?> pts"><?php echo $postssssss['num_posts']; ?>&nbsp;pts</span>)<br />
...
?>
    ...
    <div class="act_comments">
      ...
      <div align="center" class="windowbg" style="width: 353px; padding:4px;margin-bottom:8px;"><?php destacado(); ?>
      </div>
    </div>
...
?>
        <div class="postENTry" style="background-color:#FFFFCC;"><a
            href="<?php echo $boardurl; ?>/imagenes/ver/<?php echo $ui['id']; ?>" title="<?php echo $titulo; ?>"
            class="categoriaPost imagenesNOCAT"
            target="_self"><?php if (strlen($titulo) > 24) { $titulo3 = substr($titulo, 0, strrpos(substr($titulo, 0, 21), ' ')) . '...'; echo $titulo3; } else { echo $titulo; } ?></a>
        </div>
        <?php }
  if (!empty($context['user']['id'])) { ?> <center><a href="/web/cw-TEMPAgregarIMG.php" class="boxy"
            title="Agrega tu imagen">Agrega tu imagen</a></center> <?php } ?>
      </div>
    </div>
    ...
    <div class="img_aletat">
      ...
      <div class="windowbg" style="padding:4px;width:153px;margin-bottom:8px;">
        ...
        <font style="font-size:11px"><b><?php echo $dasda++; ?> - </b><?php echo $poster['link']; ?>
          (<?php echo $poster['num_posts']; ?>)</font><br />
        <?php } ?>
      </div>
    </div>
    ...
    <div class="img_aletat">
      ...
      <div class="windowbg" style="padding:4px;width:153px;margin-bottom:8px;">
        ...
        <font style="font-size:11px"><b><?php echo $dasda4++; ?> - </b><a
            href="/perfil/<?php echo $poster['realName']; ?>"
            title="<?php echo $poster['realName']; ?>"><?php echo $poster['realName']; ?></a>
          (<?php echo $poster['cuenta']; ?>)</font><br />
        <?php } ?>
    ...
    <div class="img_aletat">
      ...
      <div class="windowbg" style="padding:4px;width:153px;margin-bottom:8px;"><?php enlaces(); ?></div>
    </div>

    <?php
  if ($context['user']['name'] == 'Miguel') {
...
?>
    ...
    <div class="img_aletat">
      <div class="box_title" style="width: 161px;">
        <div class="box_txt img_aletat">Estadisticas</div>
        <div class="box_rss"><img alt="" src="<?php echo $tranfer1; ?>/blank.gif" style="width:16px;height:16px;"
            border="0" /></div>
      </div>
      <div class="windowbg" style="padding:4px;font-size:11px;width:153px;margin-bottom:8px;">
        ...
        <b style="color:green;"><?php echo ($context['invitados'] + $context['usuarios']); ?> personas
          conectadas</b><br />
        <?php echo $context['invitados']; ?> invitados conectados<br />
        <a href="/conectados/"
          title="<?php echo $context['usuarios']; ?> registrados conectados"><?php echo $context['usuarios']; ?>
          registrados conectados</a>
        <?php $context['cantidadcoment'] = mysqli_num_rows(db_query("SELECT id_coment FROM {$db_prefix}comentarios", __FILE__, __LINE__)); ?>

        <?php echo $context['cantidadcoment']; ?> comentarios
      </div>
    </div>
