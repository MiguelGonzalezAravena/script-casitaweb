...
';}
echo'<meta name="description" content="- Un sitio de distraccion, de descargas (Musica, Juegos, Programas, Peliculas,etc,etc).. Lo interesante que aca VOS sos el protagonita el que aporta sos vos, Todo eso y mucho más..." />
...
?><meta name="keywords" content="<?php  echo getMetaKeywords($context['CsTNidO']); ?>,<?php echo $titlee; ?>,rapidshare,megaupload,mediafire,<?php echo ($context['id-post']-1);?>,<?php echo ($context['id-post']-2);?>,descarga,rapidshare,megaupload,mediafire,descarga-directa,bajar,mp3,casitaweb,rigo,caladj,elblogderigo,lawebderigo,elforoderigo,linksharing,enlaces,juegos,musica,links,noticias,imagenes,videos,animaciones,arte,tecnologia,celulares,argentina,comunidad,cw,infornes,2008,2009,warez,linksharing,web 2.0,directa <?php año();?>" />
...
<div id="pie"> <?php echo' &copy; ';año();echo' <a href="/" title="casitaweb.net">casitaweb.net</a> | <a href="/protocolo/" title="Protocolo">Protocolo</a> | <a href="/enlazanos/" title="Enlazanos">Enlazanos</a> | <a href="/widget/" title="Widget">Widget</a> | <a href="/contactanos/" title="Contacto">Contacto</a> | <a href="/recomendar/" title="Recomendar CasitaWeb!">Recomendar CasitaWeb!</a> | <a href="/mapa-del-sitio/" title="Mapa del sitio">Mapa del sitio</a><div style="clear:both"></div></div></div></div>'; ?><script type="text/javascript">  var _gaq = _gaq || [];
