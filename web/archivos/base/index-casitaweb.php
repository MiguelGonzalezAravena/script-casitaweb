...
<link rel="up" href="#top" title="Volver al principio de esta pagina" /> <?php
  echo '<style rel="stylesheet" type="text/css">#logob{width:360px;height:95px;background: url(\'' . $boardurl . "/logos/logo.gif'); background-repeat:no-repeat;float:left;}</style>";
?></head>
<body id="top">
