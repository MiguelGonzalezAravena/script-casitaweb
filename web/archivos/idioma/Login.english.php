...
$txt[38] = 'No pusistes tu contrase&ntilde;a.';
...
$txt[520] = 'Puedes usar caracteres especiales despu&eacute;s de haber ingresado, cambiando tu nombre a mostrar en tu perfil.';
$txt[585] = 'Acepto';
$txt[586] = 'No acepto';
...
$txt['register_subject'] = 'CasitaWeb! - Confirmacion e-mail';

$txt['register_immediate_message']='Hola <b>%1$s</b>:'."\n\n".'Bienvenido a CasitaWeb!'."\n\n".'Para confirmar tu direcci&#243;n de correo electr&#243;nico ingresa al siguiente enlace:'."\n".'%4$s'."\n\n".$txt[130];

$txt['register_activate_message']='Hola <b>%1$s</b>:'."\n\n".'Bienvenido a CasitaWeb!'."\n\n".'Para confirmar tu direcci&#243;n de correo electr&#243;nico ingresa al siguiente enlace:'."\n".'%4$s'."\n\n".$txt[130];

$txt['resend_activate_message']='Hola <b>%1$s</b>:'."\n\n".'Bienvenido a CasitaWeb!'."\n\n".'Para confirmar tu direcci&#243;n de correo electr&#243;nico ingresa al siguiente enlace:'."\n".'%4$s'."\n\n".$txt[130];

$txt['resend_pending_message']='Hola <b>%1$s</b>:'."\n\n".'Bienvenido a CasitaWeb!'."\n\n".'Para confirmar tu direcci&#243;n de correo electr&#243;nico ingresa al siguiente enlace:'."\n".'%4$s'."\n\n".$txt[130];

$txt['ban_register_prohibited'] = 'Lo siento, no est&aacute;s autorizado para registrarte en esta Web.';
