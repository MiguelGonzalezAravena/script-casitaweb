...
global $context,$db_prefix,$user_info,$ajaxError,$modSettings;
...
<?php 
echo'<div style="width:300px;" align="center"><div id="resultado" style="display:none;"></div>
<div id="contentv">
<strong class="size9">Solo acepta BBCode</strong><br />
